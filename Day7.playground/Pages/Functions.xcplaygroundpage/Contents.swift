...
// A melhor forma é utilizando tuplas. tuplas são fixas em tamanho, os tipos de valores não podem mudar, os dados podem ser acessados por um identificador ou pela posição.
